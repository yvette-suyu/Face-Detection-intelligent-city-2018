                ...
                for ssubDirName in subDirName:
                    ...
                    for SubParent,SubDirName,SubFilenames in os.walk(path):
                        ...
                        for filename in SubFilenames:
                            if filename == "part1.jpg" or "part1.png":
...
if __name__ == '__main__':
    ...
    #         for filename in filenames:
                ...
                # print('tp',testpath)
    testdata = createImgMat(testdir)
    testsc = StandardScaler()
    testdata_std = testsc.fit_transform(testdata.T)
    testpca = PCA(n_components=625, svd_solver='randomized',whiten=True)
    testdata_rec = testpca.fit_transform(testdata_std)
    n_testsamples, n_testfeatures = testdata_rec.shape
    
    for index in range(n_testsamples):
        testface = testdata_rec[index,:]
        print('testface',testface)
